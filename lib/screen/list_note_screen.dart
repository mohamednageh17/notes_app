    ...
    return Scaffold(
      ...
      floatingActionButton: MouseRegion(
        ...
        child: FloatingActionButton(
          ...
          backgroundColor: _isHovered ? Colors.orange.shade900 : Colors.orange.shade700, // Change color on hover
                      ...
                      return GestureDetector(
                        onTap: () {
                          context.push(
                            ...
                            extra: {'title': note.title, 'content': note.content},
                          );
                        },
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: MouseRegion(
                              ...
                              child: IconButton(
                                ...
                                iconSize: 24,
                                onPressed: () {
                                  context.read<NoteBloc>().add(DeleteNote(note)); // Dispatch delete event
                                },
